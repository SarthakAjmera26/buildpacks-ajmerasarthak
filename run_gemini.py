...
def main():
    ...
    parser.add_argument("prompt", help="Try to integrate changes from https://rubyreferences.github.io/rubychanges/3.4.html#default-gems-that-became-bundled into the repo. Validate yourself by running python3 validate.py --app-dir ruby/generic/simple --version 3.4 and if needed correct yourself.")
    ...
    parser.add_argument("--commit", default="f6381f7d46df9c2d935e906661672f2261633e5b", help="The commit we want to travel back to")
